...
class Intcode():
    ...
    def op_code_3(self, address):
        ...
        self.set_memory(address, self.opcode3_inputs[self.input_pointer])
...
def solve():
    ...
    phase_settings = []
    for setting in list(itertools.permutations([0,1,2,3,4], 5)):
    ...
    for phase_setting in phase_settings:
        ...
        for i, amp in enumerate(amps):
            amp.set_inputs([phase_setting[i], prev_out])
            amp.execute()
            prev_out = amp.get_output()
